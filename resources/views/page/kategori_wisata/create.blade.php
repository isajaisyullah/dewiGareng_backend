...
@section('title', 'Wisata Create | DewiGareng')
...
<div class="card card-default mx-auto mt-3" style="width: 90%;">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <div>
                <h1 class="card-title"><b>Buat data Wisata</b></h1>
            </div>
    ...
    <div class="card-body">
        ...
        <!-- Create store form -->
            <form action="{{ route('wisataKategori.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
